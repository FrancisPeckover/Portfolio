...
<html lang="en">
    ...
    <body>
        ...
        <div id="about" class="about seperator window center">
            ...
            <p class="animated center about-text fill rounded-border" style="grid-area: femaleText;">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
            ...
            <img id="girlImg" class="animated avatar" style="grid-area: femaleImg;" src="frontend/images/female-avatar.png" alt="girl">
        ...
        <div id="contact" class="contact seperator window column">
            ...
            <h2 class="animated" style="animation: grow 500ms forwards; margin-bottom: 5%;">Let us know what you're thinking</h2>
            <form class="animated contact-form column" action="../backend/contact.php" method="post">
                ...
                <textarea style="height: 120px;" class="form-element" name="description" id="description" cols="30" rows="10" placeholder="Let us know what you're thinking" required></textarea>
